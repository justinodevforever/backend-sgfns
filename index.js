...
const routerNotify = require("./src/v1/routers/routerNotify");
const comentPage = require("./src/v1/routers/routerComentarioPagina");
const routerPublicationPage = require("./src/v1/routers/routerPublicacaoPagina");
const routerImagePage = require("./src/v1/routers/routerImagePagina");
...
const routerLikePagina = require("./src/v1/routers/routerLikePagina");
...
const routerUsuarioSistema = require("./src/v1/routers/routerUsuarioSistema");
...
const routerProfessor = require("./src/v1/routers/routerProfessor");
...
app.use("/api/v1", routerNotify);
app.use("/api/v1", comentPage);
app.use("/api/v1", routerPublicationPage);
app.use("/api/v1", routerImagePage);
app.use("/api/v1", routerPropina);
app.use("/api/v1", routerDeclaracoes);
app.use("/api/v1", routerLikePublicacao);
app.use("/api/v1", routerLikePagina);
...
app.use("/api/v1", routerUsuarioSistema);
...
app.use("/api/v1", routerProfessor);
